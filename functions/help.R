...
getDprofilerText<-function(){
  ...
  list(
           ...
           cellular dynamics of the targeted tissue, and may often be more informative than the differential expression between a group of targeted phenotypic conditions"),
                  p(style="text-align: justify;",
                  ...
                  "Users are allowed to use a variety of algorithms to calculate a ", strong("Membership Score"), "of samples associated to some phenotypic profiles of interest. 
                   Dprofiler derives reference phenotypic profiles from submitted datasets as well as cell-types of single cell maps, conditions from external gene expression data sets. 
                   These scores are universally interpretable, and indicate the similarity of a sample to these reference profiles.
                   "),
                  br(),
                  p("Dprofiler offers multiple capabilities using these three components: "),
                    tags$ul(
                      tags$li(strong("Computational Profiling: "), "Scoring and Profiling samples using homogeneouos subpopulations of targeted phenotypic reference profiles."),
...
getIntroText<-function(){
  ...
  #     ),
      ...
      tags$ul(
        tags$li(strong("Bulk Data Set: "), "used for profiling samples within and establish homogeneous reference profiles."),
        tags$li(strong("scRNA Data Set: "), "used for deconvoluting Bulk RNA data and infering cellular compositions of these bulk samples."),
        tags$li(strong("Reference Bulk Data Set: "), "used for comparatively profiling the Bulk data set using reference phenotypic profiles of another bulk data set."),
      ),
      p(style="text-align: justify;",
      "For both Submitted Bulk and Reference Bulk Data sets, there are two distinct inputs given in '.txt', '.csv' or '.tsv' formats.
    ...
    download."),
      ...
      p(style="text-align: justify;",
      "This input file should contain summarized count results of all samples in the experiment, 
  ...
  using the example table at below:"),
      ...
      p(style="text-align: justify;",
      "After sucessfully uploading your data, you should see the summary of your data in the 'Upload Summary' section. 
    ...
    p(style="text-align: justify;",
    "However, for scRNA data set, the user should provide an ExpressionSet object with metadata data slot 
...
getDataAssesmentText<-function(){
  list(
    column(8,
      ...
      h4("2.1 Filtering"),    
      p(style="text-align: justify;",
        "In this section, you can simultaneously visualise the changes of your dataset 
...
getCompProfilingText <-function(){
  list(
    column(6,
      ...
      p(style="text-align: justify;",
        "Dprofiler provides methods for calculating membership scores to be used to profiling samples associated to specific phenotypic profiles of reference."),
      p(style="text-align: justify;", 
        "By iteratively removing samples with low scores and repeatatively searching for differentially expressed genes, computational profiling analysis of 
         ...
         homogeneous reference profiles of these phenotypic groups, and they are used to calculate the final score to establish the profile of 
        ...
        tags$li(strong("Score Method:"), " The algorithm to determine membership scores of each individual sample:",
                tags$ul(
                  tags$li(style="text-align: justify;",
                          ...
                          average distances to the members of one condition and average distance to the ones of the other condition."),
                  tags$li(style="text-align: justify;",
                          strong("NNLS "), "estimates the score with a non-negative least squares regression where each 
                          sample modeled against mean expression profiles of each condition/phenotype.")
                )
        ),
        tags$li(style="text-align: justify;",
...
getCompCellularText <-function(){
  list(
    column(6,
           ...
           p(style="text-align: justify;",
             "Dprofiler provides methods for Deconvolution of Bulk expression data sets using annotated reference single cell datasets. 
              Dprofiler primarily uses MuSIC algorithm for Deconvolution."),
           
           p("Parameters that are used to conduct Cellular Composition Analysis (or Deconvolution) are:"),
           tags$ul(
             tags$li(strong("Select Meta: "), "Identification type that specifies the reference profiles such as cell type or sub cell type."),
             ...
             tags$li(strong("DE genes: "), " The protocol for selecting genes to deconvolute bulk samples",
                     tags$ul(
                       tags$li(strong("Heterogeneous Conditions: "), "DE genes of Heterogeneous (original) conditions."),
                       tags$li(strong("Homogeneous Conditions: "), "DE genes of Homogeneous conditions found by Computational Profiling."),
           ...
           p(style="text-align: justify;",
             ...
             expression datasets (Wang et al.). 
             A specific feature of MUSIC allows the proportions of closely related cell types to be correctly estimated. To deal with collinearity,
             MuSiC employs a tree-guided procedure that recursively zooms in on closely related cell types. Rather than pre-selecting marker genes 
...
getComparativeProfText <-function(){
  list(
    column(6,
           ...
           p(style="text-align: justify;",
             "Dprofiler provides methods for calculating membership scores to be used to profiling samples associated to 
             specific phenotypic profiles of external reference datasets."),
           p("By conducting DE analysis to reference phenotypes of the external reference gene expression data set, Dprofiler
             uses an overlapping set of differentially expressed genes of both submitted and reference bulk data sets to compute Membership scores."),
